# -*- coding: utf-8 -*-
"""YThumbnailNet Top 5 25 class ENB4

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1c_CDp8X-PvJGpOZj88kBA1NAZpuHGVGZ
"""
...
train_data_loader = DataLoader(dataset, batch_size=batch_size, shuffle=True, num_workers=suggested_num_workers)
...
for epoch in range(num_epochs):
    ...
    for i, (images, labels) in enumerate(train_data_loader):
        ...
        running_top5_error += 100.0 - top5_acc.item()
        ...
        if total_images % 1000 == 0:
            print(f"Processed {total_images} images - Average Loss: {running_loss / (i + 1)}, "
                  ...
                  f"Top-5 Accuracy: {100 - running_top5_error / (i + 1)}")
    ...
    model_weights_path = "model_weights_multi_guess5of25EFF.pth"
